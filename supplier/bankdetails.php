    ...
    <div class="container" style="height: 150%; width: 40%;" >
        ...
        <div class="row pt-3" id="row-2">
            <div class="col-11 col-xl-12">
                <input class="form-control" type="text" name="bankName" id="bankName" placeholder="Bank Name" required data-error="Please enter your bank name">
        ...
        <div class="row pt-3 " id="row-2">
            <div class="col-11 col-xl-12">
                <input class="form-control" type="number" name="accountnumber" id="accountnumber" placeholder="Account Number"required data-error="Please enter your account number">
                <div class="help-block with-errors"></div>
            </div>
        </div>
        ...
        <div class="row pt-3" id="row-4">
            <div class="col-11 col-xl-12">
                <input class="form-control" type="number" name="ifsccode" id="ifsccode" placeholder="IFSC Code">
            </div>
        </div>

        <div class="row pt-3" id="row-5">
            <div class="col-11 col-xl-12">
                <input class="form-control" type="text" name="Accountholdername" id="Accountholdername" placeholder="Account Holder Name"required data-error="Please enter your Account holder name">
                <div class="help-block with-errors"></div>
            </div>
        </div>
        ...
        <div class="row pt-3" id="row-6">
            <div class="col-11 col-xl-12">
                <input class="form-control" type="number" name="pancardnumber" idate="pancardnumber" placeholder="Pan Card Number"required data-error="Please enter your pan card number">
                <div class="help-block with-errors"></div>
            </div>
        </div>
        ...
        <div class="row pt-3" id="row-10">
            <div class="col-8 ">
                <a href="index.php"><input name="Submit" class="btn btn-primary"  value="Submit"></a>
                <br>
            </div>
        </div>
    </center>
